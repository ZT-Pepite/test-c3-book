...
1.  In the "Select installation language" interface shown in Figure 4.5,
    select the language to be used from the drop-down list. Here,
    Simplified Chinese is selected.

    <!-- !["Select installation language" interface](Pics/D4Z/4-5.png) -->
<figure align="center">
    <img src="../../Pics/D4Z/4-5.png" width="80%">
    <figcaption>Figure 4.5. Select installation language</figcaption>
</figure>


2.  After selecting the language, click "OK" to pop up the "License
    agreement" interface (see Figure 4.6). After carefully reading the
    installation license agreement, select "I agree to this agreement"
    and click "Next".

    <!-- !["License agreement" interface](Pics/D4Z/4-6.png) -->

<figure align="center">
    <img src="../../Pics/D4Z/4-6.png" width="80%">
    <figcaption>Figure 4.6. "License agreement" interface</figcaption>
</figure>
...
<figure align="center">
    <img src="../../Pics/D4Z/4-7.png" width="80%">
...
4.  Select the ESP-IDF installation directory. Here, select
    ...
    <figure align="center">
    <img src="../../Pics/D4Z/4-8.png" width="80%">
...
6.  Confirm the components to be installed and click "Install" to start
...
<!-- ![Installation progress bar](Pics/D4Z/4-11.png) -->

<figure align="center">
    <img src="../../Pics/D4Z/4-11.png" width="80%">
    <figcaption>Figure 4.11. Installation progress bar</figcaption>
</figure>
...
<figure align="center">
    <img src="../../Pics/D4Z/4-13.png" width="80%">
    <figcaption>Figure 4.13. Development environment installed</figcaption>
</figure>

<!-- ![ESP-IDF 4.3 CMD](Pics/D4Z/4-14.png) -->

<figure align="center">
    <img src="../../Pics/D4Z/4-14.png" width="80%">
